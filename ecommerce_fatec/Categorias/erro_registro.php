        ...
        <div class="container">
          ...
          >
            <div class="mb-3 mb-md-0">
                <?php  
       echo "<h4>Erro! - A categoria $nome já foi registrada!</h4>";  
    
        ?>
                <p><a href="../Funcionario/employee-menu.html">Voltar</a></p>
            ...
            <div class="page_link">
             ...
             <a href="insert-categoria.html">Registro de categorias</a>
             <a href="#">Erro!</a>
            </div>
          </div>
        </div>
