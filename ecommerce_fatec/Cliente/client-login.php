     ...
     if (isset($_SESSION["cliente"])){
            //cliente logado
             ...
             foreach ($vet as $key => $registro) {
                    $id = $key;
                    $codigo_session = $registro["id"];
                    $nome_session = $registro["nome"];
                    
                }
           
                header("Location:cliente_menu.php?cod=$codigo_session");
        ...
        <div class="container">
          ...
          >
            <div class="mb-3 mb-md-0">
              ...
              <p>Para realizar compras no site, você deve estar logado primeiro</p>
            </div>
            <div class="page_link">
              <a href="../index.php">Home</a>
              <a href="">Login do cliente</a>
            </div>
          </div>
        </div>
      </div>
              ...
              >
                ...
                <div class='col-md-12 form-group p_star'>
                 <input
                    type='text'
                    class='form-control'
                        placeholder='CPF (Com traços e pontos)'
                        name='CPF'
                  ...
                  />
                   ...
                   <button type='submit' class='main_btn'>Entrar</button>
              </form>
            </div>
          </div>
        </div>
        <br>
        <p>Novo por aqui? <a href='cadastro-cliente.html'>Cadastre-se</a></p>
