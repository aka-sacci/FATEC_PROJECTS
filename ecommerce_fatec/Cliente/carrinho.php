...
<html lang="en">
  ...
  <div class="section-top-border">
        <h3 class="mb-30 title_color">Carrinho</h3>
        <div class="progress-table-wrap">
          <div class="progress-table">
            ...
            if (isset($produtos)){
              ...
              <div class='visit'><a href='remove_carrinho.php?cod=$CPF' class='genric-btn danger small'>Remover</a></div>
              </div>";
              $cont = $cont + 1;
                  }
     ...
     ?>
              ...
              <?php
       if(isset($produtos)){
       echo "<p align='right'>Subtotal: R$ $subtotal</p>";
        }
       ?>
          </div>
        </div>
       ...
       if(isset($produtos)){
          ...
          echo "<a type='' class='genric-btn info' href='finalizar_compra.php'>Avançar</a>    ";
          echo "<a class='genric-btn danger' href='exclui_carrinho.php'>Excluir carrinho</a>";
