        ...
        <div class="container">
          ...
          >
            <div class="mb-3 mb-md-0">
                <?php  
       echo "<h4>Compra realizada com sucesso! Clique <a href='cliente_menu.php?cod=$CPF'>aqui</a> para voltar à área do cliente</h4>";  
    
        ?>
                
              <a class='genric-btn info' href="../Arquivos/Abrir_arquivo.php?cod=<?php echo $compra; ?>">Ver pseudo-comprovante</a> 
            </div>
            <div class="page_link">
