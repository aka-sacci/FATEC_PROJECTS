        ...
        <div class="container">
          ...
          >
            <div class="mb-3 mb-md-0">
                <?php  
       echo "<h4>Erro! - O estoque do produto $nome é menor do que a quantidade em seu carrinho!</h4>
       <h4> Tente <a href='remove_carrinho.php?cod=$cod'>remover o produto do carrinho</a> ou <a href='../shop/single-product.php?produto=$cod'>diminuir a quantidade</a> </h4>";  
    
        ?>
                <p><a href="carrinho.php">Voltar</a></p>
