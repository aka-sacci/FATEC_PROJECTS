...
include_once "../Funcoes/BancoDeDados.php";
        ...
        $conexao = conectar(); 
        $sql = "select cpf_cnpj_transp, nome_tras from transportadora order by nome_tras ASC"; 
        ...
        <div class="container">
          ...
          >
            <div class="mb-3 mb-md-0">
              <h2>Seleção de transportadora</h2>
              <p>Escolha uma transportadora para alterar os dados.</p>
            ...
            <div class="page_link">
             ...
             <a href="#">Selecionar transportadora</a>
            </div>
          </div>
        </div>
      </div>
