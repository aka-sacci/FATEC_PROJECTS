...
<html lang="en">
  <head>
    ...
    <title>Canui - Tranportadora</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="container">
          ...
          >
            <div class="mb-3 mb-md-0">
                <?php  
       echo "<h4>Erro! - A transportadora com o CNPJ $CPF já foi registrada!</h4>";  
    
        ?>
                <p><a href="insert-transp.html">Voltar</a></p>
            ...
            <div class="page_link">
             ...
             <a href="insert-transp.php">Registro de transportadora</a>
             <a href="#">Erro!</a>
            </div>
          </div>
        </div>
