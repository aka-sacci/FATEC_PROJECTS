...
include_once "../Funcoes/BancoDeDados.php";
        ...
        $conexao = conectar(); 
        $sql = "select * from transportadora where cpf_cnpj_transp = '$CPF'"; 
  ...
  <head>
    ...
    <title>Canui - Transportadora</title>
    <!-- Bootstrap CSS -->
  ...
  <body>
        ...
        <div class="container">
          ...
          >
            <div class="mb-3 mb-md-0">
              <h2>Alterar cadastro de transportadora</h2>
            ...
            <div class="page_link">
             ...
             <a href="selecionar_transp.php">Selecionar transportadora</a>
    ...
    <section class="checkout_area section_gap">
      <div class="container">
            ...
            <div class="col-lg-8">
              ...
              <?php 
                  foreach ($resultado as $key => $registro) {
                    $id = $key;
                    $CPF = $registro["cpf_cnpj_transp"];
                    $nome = $registro["nome_tras"];
                    $endereco = $registro["endereco_trans"];
                    $telefone = $registro["numero_trans"];
                    $bairro = $registro["bairro_trans"];
                    $cidade = $registro["cidade_trans"];
                    $UF = $registro["estado_trans"];
                    $CEP = $registro["cep_trans"];
               ...
               ?>
                ...
                <div class="col-md-6 form-group p_star">
                  ...
                  <input
                    ...
                    class="form-control"
                    name="bairro"
                    placeholder="Bairro da transportadora"
                  ...
                  <input
                    ...
                    class="form-control"
                    name="cidade"
                    placeholder="Cidade da transportadora"
                ...
                <div class="col-md-12 form-group p_star">
                  <input
                    ...
                    class="form-control"
                    name="CEP"
                    placeholder="CEP da transportadora (Apenas números)"
                     <?php   echo "value='$CEP'";?>
                    required  
                  ...
                  <div class="col-md-6 form-group p_star">
                    ...
                    <?php 
        $conexao = conectar();
        $sql = "SELECT numero_compra FROM compra WHERE cpf_cnpj_transp = $CPF GROUP BY cpf_cnpj_transp ";
        $resultado = $conexao->query($sql);
        ...
        if($retorno != "0") {
          echo "<button href='deleta_transp.php.php?cod=$CPF' class='genric-btn danger radius main_btn' disabled>Excluir</button>";
          echo "<p>Esse produto não pode ser deletado, pois há vendas registradas com esse produto</p>";
      }
        else echo "<a href='deleta_transp.php?cod=$CPF' class='genric-btn danger radius main_btn'>Excluir</a>";
