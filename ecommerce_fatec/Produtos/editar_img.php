...
<?php
$cod = $_REQUEST["cod"];
$cod_img = $_REQUEST["cod_img"];
$img = $_REQUEST["img"];
include_once "../Funcoes/BancoDeDados.php";
    
       
        $conexao = conectar(); 
        $sql = "select codigo_img, nome_arquivo from imagem where codigo_prod = '$cod' and codigo_img != '$cod_img'"; 
...
<html lang="en">
  ...
  <body>
    ...
    <section class="checkout_area section_gap">
      <div class="container">
          <h2>Imagem já registradas</h2><br>
 <div class="row">
           ...
           <?php 
            ...
            echo "<div class='col-lg-3 col-md-6'>
                          ...
                          <p><b>IMAGEM BASE, NÃO EDITÁVEL</b></p>
                          </div>
                          </div>";

                 foreach ($resultado as $key => $registro) {
                    $id = $key;
                    $imagem = $registro["codigo_img"];
                    $arquivo = $registro["nome_arquivo"];
                   echo "<div class='col-lg-3 col-md-6'>
                          <div class='single-feature'>
                          <img src='$arquivo' width='172' height='169' >
                          <p><a href='deleta_img.php?cod=$imagem' class='genric-btn primary small danger'>Excluir Imagem</a></p>
                          </div>
                          </div>";
       ...
       <form
              ...
              >
                ...
                <div class="col-md-12 form-group p_star">
                 Inserir mais uma imagem: <input type="file" name="arquivo" required/>
