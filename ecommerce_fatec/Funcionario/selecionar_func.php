        ...
        <div class="container">
          ...
          >
            <div class="mb-3 mb-md-0">
              ...
              <p>Escolha um funcionário para alterar os dados.</p>
              
            </div>
            <div class="page_link">
              <a href="../index.php">Home</a>
              <a href="employee-login.html">Área do Funcionário</a>
             <a href="employee-menu.html">Menu</a>
             <a href="#">Selecionar funcionário</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12 form-group p_star">
                  ...
                  foreach ($resultado as $key => $registro) {
                    $id = $key;
                    $CPF = $registro["cpf_cnpj_vend"];
                    $nome = $registro["nome_vend"];
                   ...
                   <button class="main_btn" type="submit">Avançar</button>
              </form>
            </div>
